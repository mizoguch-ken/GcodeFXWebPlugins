 ...
 * @author mizoguch-ken
 */
public class StageVariables implements GcodeFXWebViewerPlugin {

    private GcodeFXWebViewerPlugin webViewer_;
    private static final String FUNCTION_NAME = "stageVariables";
    ...
    public String getVariables() {
        return virtualMachineSettings_.getVariablesValue();
    }
     ...
     * @return
     */
    public Boolean setVariables(String value) {
        if (virtualMachineSettings_.isRunning()) {
            webViewer_.write(FUNCTION_NAME, "Disabled state", true);
        } else {
            virtualMachineSettings_.setVariablesValue(value);
            return true;
        }
        return false;
    }
