 ...
 * @author mizoguch-ken
 */
public class StageMacroCall implements GcodeFXWebViewerPlugin {

    private GcodeFXWebViewerPlugin webViewer_;
    private static final String FUNCTION_NAME = "stageMacroCall";
    ...
    public String getGcode() {
        return virtualMachineSettings_.getMacroCallGValue();
    }
    ...
    public Boolean setGcode(String code) {
        if (virtualMachineSettings_.isRunning()) {
            ...
            virtualMachineSettings_.setMacroCallGValue(code);
            return true;
        }
        return false;
    }
    ...
    public String getMcode() {
        return virtualMachineSettings_.getMacroCallMValue();
    }
    ...
    public Boolean setMcode(String code) {
        if (virtualMachineSettings_.isRunning()) {
            ...
            virtualMachineSettings_.setMacroCallMValue(code);
            return true;
        }
        return false;
    }
