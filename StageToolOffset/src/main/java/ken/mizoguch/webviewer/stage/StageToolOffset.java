 ...
 * @author mizoguch-ken
 */
public class StageToolOffset implements GcodeFXWebViewerPlugin {

    private GcodeFXWebViewerPlugin webViewer_;
    private static final String FUNCTION_NAME = "stageToolOffset";
     ...
     * @return
     */
    public String getToolOffset() {
        return virtualMachineSettings_.getToolOffsetValue();
    }
     ...
     * @return
     */
    public Boolean setToolOffset(String value) {
        if (virtualMachineSettings_.isRunning()) {
            webViewer_.write(FUNCTION_NAME, "Disabled state", true);
        } else {
            virtualMachineSettings_.setToolOffsetValue(value);
            return true;
        }
        return false;
    }
